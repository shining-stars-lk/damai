...
public class SentinelZuulPreFilter extends ZuulFilter {
    ...
    public Object run() throws ZuulException {
        ...
        String fallBackRoute = resourceName;
        try {
            if (StringUtil.isNotBlank(resourceName)) {
                ContextUtil.enter(GATEWAY_CONTEXT_ROUTE_PREFIX + resourceName, origin);
                doSentinelEntry(resourceName, RESOURCE_MODE_ROUTE_ID, ctx, holders);
            }
