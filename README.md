...
可以说项目是简历中最重要的部分，但这样就产生了一个问题，大家都需要具有价值亮点的项目，可哪有那么多亮点的项目？相信大家一定听过某个培训结构下的**某谷商城** 和 **某吉外卖**，实话说，这两个项目确实不错，亮点也不少。但大家写的是在是太多太多了！面试官打眼一看 全是这两种项目 很容易就产生审美疲劳，现在有的面试官看到是简历中含有这两种项目直接就会拒绝。而且大家的项目都一样，都是通过同一个视频或者机构来学习的，根本也体现不出个人价值亮点。
...
- 项目配套的文档把结构和重难点都分层次的列举了出来，也有相关的视频，并且还配有流程图，方便小伙伴能更清晰的理解
...
一方面其实面试官并不会对你做过的业务太感兴趣，太复杂了也听不懂，**只想让你能把业务和解决问题的能力结合起来给他讲**，另一方面就是 项目的目的是让你提供技术能力，业务固然重要，但还是希望以后能把学到的技术应用到自己的项目中做到融会贯通。

而本项目争取让小伙伴尽可能快速理解业务的前提下，充分的来提供技术能力，尽量减少不必要的时间和精力

下面来介绍项目中的各个亮点部分，可以分成多个部分，比如涉及到用户服务的业务时，项目在海量并发的场景下的问题：
...
本人提供了120+的文档讲解，字数也是超过了26w+，目前仍在不断更新中，包括对 **项目从0到1的讲解**、**项目的细节和亮点总结**、**遇到的面试真题**、**详细的各种优化后的压测报告**、**如何将项目有亮点的写到简历上**。并且提供后续的答疑解惑，小伙伴在学习项目时遇到没有理解的问题，或者面试过程中遇到的问题都可以在社区中进行反馈，本人会进行详细的分析解答
