...
public interface RedisCache {
     ...
     * @return
     */
    Long addForSortedSet(RedisKeyWrap redisKeyWrap, Map<?, Double> map);
     ...
     * @return
     */
    Long addForSortedSet(RedisKeyWrap redisKeyWrap, Map<?, Double> map, long ttl);
     ...
     * @return 影响的条目
     */
    Long addForSortedSet(RedisKeyWrap redisKeyWrap, Map<?, Double> map, long ttl, TimeUnit timeUnit);
     ...
     * @return 结果set集合
     */
    <T> Set<T> getRangeForSortedSet(RedisKeyWrap redisKeyWrap, long start, long end, Class<T> clazz);
     ...
     * @return 结果set集合
     */
    <T> Set<T> getReverseRangeForSortedSet(RedisKeyWrap redisKeyWrap, long start, long end, Class<T> clazz);
     ...
     * @return
     */
    <T> Set<ZSetOperations.TypedTuple<T>> rangeWithScoreForSortedSet(RedisKeyWrap redisKeyWrap, long start, long end, Class<T> clazz);
     ...
     * @return
     */
    <T> Set<T> rangeByScoreForSortedSet(RedisKeyWrap redisKeyWrap, double min, double max, Class<T> clazz);
     ...
     * @return
     */
    <T> Set<ZSetOperations.TypedTuple<T>> rangeByScoreWithScoreForSortedSet(RedisKeyWrap redisKeyWrap, double min, double max, Class<T> clazz);
     ...
     * @return
     */
    <T> Set<ZSetOperations.TypedTuple<T>> rangeByScoreWithScoreForSortedSet(RedisKeyWrap redisKeyWrap, double min, double max,
     ...
     * @return
     */
    <T> Set<ZSetOperations.TypedTuple<T>> reverseRangeWithScoreForSortedSet(RedisKeyWrap redisKeyWrap, long start, long end, Class<T> clazz);
     ...
     * @return
     */
    <T> Set<T> reverseRangeByScoreForSortedSet(RedisKeyWrap redisKeyWrap, double min, double max, Class<T> clazz);
     ...
     * @return
     */
    <T> Set<ZSetOperations.TypedTuple<T>> reverseRangeByScoreWithScoreForSortedSet(RedisKeyWrap redisKeyWrap, double min, double max, Class<T> clazz);
     ...
     * @return
     */
    <T> Set<T> reverseRangeByScoreForSortedSet(RedisKeyWrap redisKeyWrap, double min, double max, long start, long end, Class<T> clazz);
     ...
     * @return
     */
    Long unionAndStoreForSortedSet(RedisKeyWrap redisKeyWrap, Collection<RedisKeyWrap> otherRedisKeyWraps, RedisKeyWrap destRedisKeyWrap);
     ...
     * @return
     */
    Long intersectAndStoreForSortedSet(RedisKeyWrap redisKeyWrap, Collection<RedisKeyWrap> otherRedisKeyWraps, RedisKeyWrap destRedisKeyWrap);
     ...
     * @return
     */
    Cursor<ZSetOperations.TypedTuple<String>> scanForSortedSet(RedisKeyWrap redisKeyWrap, ScanOptions options);
