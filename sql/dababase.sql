-- 创建数据库
create database if not exists damai character set utf8mb4;
...
create database if not exists damai_order character set utf8mb4;
...
create database if not exists damai_pay character set utf8mb4;
...
create database if not exists damai_program character set utf8mb4;
...
create database if not exists damai_user character set utf8mb4;