...
package com.example.agent.core.plugin.jdk9module;
...
public class JDK9ModuleExporter {
    ...
    private static final String[] HIGH_PRIORITY_CLASSES = {
            ...
            "com.example.agent.core.plugin.interceptor.enhance.ConstructorInter",
            "com.example.agent.core.plugin.interceptor.enhance.InstMethodsInter",
            "com.example.agent.core.plugin.interceptor.enhance.InstMethodsInterWithOverrideArgs",
            "com.example.agent.core.plugin.interceptor.enhance.StaticMethodsInter",
            "com.example.agent.core.plugin.interceptor.enhance.StaticMethodsInterWithOverrideArgs",
    };
