...
public class ProducerConfig {
    ...
    @Bean
    public OrderMessageSend orderMessageSend(KafkaTemplate<String, String> kafkaTemplate,ProducerProperty producerProperty){
        return new OrderMessageSend(kafkaTemplate,producerProperty.getTopic());
    }
}
