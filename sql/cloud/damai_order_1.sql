...
--
-- Table structure for table `d_order_4`
--

DROP TABLE IF EXISTS `d_order_4`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `d_order_4` (
  `id` bigint(20) NOT NULL COMMENT '主键id',
  `order_number` bigint(20) NOT NULL COMMENT '订单编号',
  `program_id` bigint(20) NOT NULL COMMENT '节目表id',
  `program_item_picture` varchar(1024) DEFAULT NULL COMMENT '节目图片介绍',
...
--
-- Dumping data for table `d_order_4`
--

LOCK TABLES `d_order_4` WRITE;
/*!40000 ALTER TABLE `d_order_4` DISABLE KEYS */;
/*!40000 ALTER TABLE `d_order_4` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `d_order_ticket_user_4`
--

DROP TABLE IF EXISTS `d_order_ticket_user_4`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `d_order_ticket_user_4` (
  `id` bigint(20) NOT NULL COMMENT '主键id',
  `order_number` bigint(20) NOT NULL COMMENT '订单编号',
  `program_id` bigint(20) NOT NULL COMMENT '节目表id',
  `user_id` bigint(20) NOT NULL COMMENT '用户id',
...
--
-- Dumping data for table `d_order_ticket_user_4`
--

LOCK TABLES `d_order_ticket_user_4` WRITE;
/*!40000 ALTER TABLE `d_order_ticket_user_4` DISABLE KEYS */;
/*!40000 ALTER TABLE `d_order_ticket_user_4` ENABLE KEYS */;
UNLOCK TABLES;
