...
package com.example.agent.core.conf;


import com.example.agent.core.logging.core.LogLevel;
import com.example.agent.core.logging.core.LogOutput;
import com.example.agent.core.logging.core.ResolverType;
import com.example.agent.core.logging.core.WriterFactory;
import com.example.agent.core.plugin.bytebuddy.ClassCacheMode;
import com.example.agent.core.util.Length;

import java.util.Arrays;
import java.util.List;

/**
 * This is the core config in cook-async agent.
 */
public class Config {
    ...
    public static class Agent {
        ...
        /**
         * If true, cook-async agent will save all instrumented classes files in `/debugging` folder. cook-async team
         * may ask for these files in order to resolve compatible problem.
         */
        public static boolean IS_OPEN_DEBUGGING_CLASS = false;

        /**
         * If true, cook-async agent will cache all instrumented classes to memory or disk files (decided by class cache
         * mode), allow other javaagent to enhance those classes that enhanced by cook-async agent.
         */
    ...
    public static class Collector {
        ...
        /**
         * Collector cook-async trace receiver service addresses.
         */
        ...
        /**
         * If true, cook-async agent will enable periodically resolving DNS to update receiver service addresses.
         */
    ...
    public static class Profile {
        ...
        /**
         * If true, cook-async agent will enable profile when user create a new profile task. Otherwise disable
         * profile.
         */
    ...
    public static class Meter {
        ...
        /**
         * If true, cook-async agent will enable sending meters. Otherwise disable meter report.
         */
        public static boolean ACTIVE = true;
    ...
    public static class Logging {
         ...
         * Log file name.
         */
        public static String FILE_NAME = "cook-async-api.log";

        /**
         * Log files directory. Default is blank string, means, use "{thecook-asyncAgentJarDir}/logs  " to output logs.
         * {thecook-asyncAgentJarDir} is the directory where the cook-async agent jar file is located.
         * <p>
         ...
         *
         * @see com.example.agent.core.logging.core.PatternLogger#DEFAULT_CONVERTER_MAP
         */
