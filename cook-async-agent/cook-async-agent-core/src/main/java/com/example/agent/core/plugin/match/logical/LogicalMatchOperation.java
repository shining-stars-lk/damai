...
package com.example.agent.core.plugin.match.logical;
...
/**
 * Util class to help to construct logical operations on {@link com.example.agent.core.plugin.match.ClassMatch}s
 */
