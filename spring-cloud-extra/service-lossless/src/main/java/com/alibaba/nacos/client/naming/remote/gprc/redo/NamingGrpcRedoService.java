    ...
    public void cacheSubscriberForRedo(String serviceName, String groupName, String cluster) {
        ...
        synchronized (subscribes) {
            ...
            for (StackTraceElement stackTraceElement : stackTrace) {
                ...
                list.add("className:" + className + " methodName:" + methodName);
            }
            LogUtils.NAMING_LOGGER.info("cacheSubscriberForRedo key:{} redoData:{} stackTrace:{}",key, JSONObject.toJSONString(redoData), JSONObject.toJSONString(list));
